...
export class Schema<T extends SchemaDefinition, M extends MethodsDefinition> {

    [methods]: M;
    [schemaData]: T;

    public constructor(data: T, methodsData?: M, public readonly options: SchemaOptions = {}) {
        this[schemaData] = this.parse(data);
        this[methods] = methodsData ?? <any>{};
    ...
    public methods<X extends MethodsDefinition>(data: X) {
